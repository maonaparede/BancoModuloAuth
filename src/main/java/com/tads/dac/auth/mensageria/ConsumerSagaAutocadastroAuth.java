...
@Component
public class ConsumerSagaAutocadastroAuth{
    ...
    @RabbitListener(queues = "auto-auth-saga")
    public void commitOrdem(@Payload MensagemDTO msg) {
        ...
        template.convertAndSend("auto-auth-saga-receive", msg);
    }

    @RabbitListener(queues = "auto-auth-saga-rollback")
